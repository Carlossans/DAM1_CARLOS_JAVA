...
public class Principal {
    public static void main(String[] args) {
        ...
        System.out.println("\n3. Frase1 después de anexar 'Primera': '" + frase1 + "'");
        frase1.anexar("palabra");
        System.out.println("   Frase1 después de anexar 'palabra': '" + frase1 + "'");

        // Probando recortar
        frase2.recortar(3);
        System.out.println("\n4. Frase2 después de recortar 3 caracteres: '" + frase2 + "'");

        // Probando clone
        Frase frase3 = frase2.clone();
        System.out.println("\n5. Frase3 (clon de frase2): '" + frase3 + "'");
