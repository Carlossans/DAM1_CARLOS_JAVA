void main() {
    ...
    do {
        ...
        IO.println("1. Comparación de 2 arrays de números enteros.");
        IO.println("2. Comparación de 2 arrays de números decimales.");
        IO.println("3. Comparación de 2 arrays de valores (Verdadero/Falso).");
        ...
        switch (opcion) {
            ...
            case 3 -> {
                IO.println("\n----------LISTA DE VALORES (VERDADERO/FALSO)----------");
