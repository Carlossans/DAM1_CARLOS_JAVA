void main() {
    ...
    do {
        ...
        IO.println("\u001B[35m" + "3. Comparación de 2 arrays de valores (Verdadero/Falso)." + "\u001B[0m");
        ...
        switch (opcion) {
            ...
            case 3 -> {
                IO.println("\n" + "\u001B[35m" + "----------LISTA DE VALORES (VERDADERO/FALSO)----------" + "\u001B[0m");
                ...
                if (nbooleans1 - nbooleans2 == 0) {
                    ...
                    IO.println("\n" + "\u001B[35m" + "----COMIENZA LA LISTA 1 DE VALORES (VERDADERO/FALSO)----\n" + "\u001B[0m");
                    ...
                    IO.println("\n" + "\u001B[35m" + "----COMIENZA LA LISTA 2 DE VALORES (VERDADERO/FALSO)----\n" + "\u001B[0m");
