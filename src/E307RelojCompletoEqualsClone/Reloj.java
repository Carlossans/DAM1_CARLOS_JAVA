...
public class Reloj {
    ...
    public void sumar(int minutos) throws DesbordamientoRelojException, OperacionNegativaRelojException {
        if (minutos < 0) throw new OperacionNegativaRelojException("No me pongas negativos. Inténtalo de nuevo.");
        if (60*h+m + minutos >= 24*60) throw new DesbordamientoRelojException("Te has intentado salir del rango.", true);
    ...
    public void restar(int minutos) throws DesbordamientoRelojException, OperacionNegativaRelojException {
        if (minutos < 0) throw new OperacionNegativaRelojException("No me pongas negativos. Inténtalo de nuevo.");
        if (60*h+m - minutos < 0) throw new DesbordamientoRelojException("Te has intentado salir del rango.", false);
